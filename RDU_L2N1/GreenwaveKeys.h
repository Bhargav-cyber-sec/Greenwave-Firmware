 ...
 *
 * Device : RDU L2N1 (intersection 1)
 * ICU public-key table index : 2
 *
 ...
 * ------------------------------------------------------------------
 * The ICU already holds the PUBLIC key for this node at index 2 of
 * GW_RDU_PUBLIC_KEYS in ICU/GreenwaveKeys.h, from key set 7e200d93:
 *
 *     37 6d 4f 4a 18 20 52 77 83 f2 5d f0 f7 ca b2 8a
 *     02 86 af 9f 79 97 fb 48 f9 92 02 82 91 10 54 06
 *
...
#error "RDU_L2N1/GreenwaveKeys.h is a PLACEHOLDER. Provision this node before building. See the handover note at the top of this file."
#endif
