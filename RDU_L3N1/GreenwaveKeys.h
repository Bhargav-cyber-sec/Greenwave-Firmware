 ...
 *
 * Device : RDU L3N1 (intersection 1)
 * ICU public-key table index : 4
 *
 ...
 * ------------------------------------------------------------------
 * The ICU already holds the PUBLIC key for this node at index 4 of
 * GW_RDU_PUBLIC_KEYS in ICU/GreenwaveKeys.h, from key set 7e200d93:
 *
 *     90 de f9 c1 38 23 fe 2a d6 fc 73 da 3b f2 95 43
 *     1e a0 22 7a 24 0e 75 f2 76 5a f2 e0 d9 7b 89 71
 *
...
#error "RDU_L3N1/GreenwaveKeys.h is a PLACEHOLDER. Provision this node before building. See the handover note at the top of this file."
#endif
